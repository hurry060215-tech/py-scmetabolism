...
| | |
|---:|:---|
| **CI/CD** | [![Build Status](https://github.com/omicverse/py-scmetabolism/actions/workflows/ci.yml/badge.svg)](https://github.com/omicverse/py-scmetabolism/actions) ![Python Versions](https://img.shields.io/pypi/pyversions/py-scmetabolism) |
